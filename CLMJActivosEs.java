...
public class CLMJActivosEs {
	...
	@Test
	public void mjactivoses() throws InterruptedException {
		...
		// juuk Pendientes
		driver.findElement(By.xpath("/html[1]/body[1]/div[1]/section[1]/div[1]/div[3]/a[1]")).click(); 
		Thread.sleep(10000);
				
		// juuk pendientes atras	
		driver.findElement(By.xpath("//body/div[@id='__next']/section[1]/div[2]/div[1]/*[1]")).click(); 
		Thread.sleep(3000);
