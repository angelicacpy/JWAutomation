...
public class SLFiltrosIn {
	...
	@Test
	public void filtrosin() throws InterruptedException {
		...
		//filtros
			driver.findElement(By.xpath("//*[@id=\"__next\"]/section/div[2]/div[1]/button")).click();
				...
				//Limpiar Filtros
				driver.findElement(By.xpath("//button[contains(text(),'Delete All')]")).click();
				Thread.sleep(3000);
				...
				jsx3.executeScript("window.scrollBy(0,-750)", ""); 
				...
				jsx4.executeScript("window.scrollBy(0,850)", "");
				...
				jsx5.executeScript("window.scrollBy(0,-850)", "");
				...
				jsx6.executeScript("window.scrollBy(0,1150)", "");
				...
				jsx7.executeScript("window.scrollBy(0,-1150)", ""); 
				...
				jsx8.executeScript("window.scrollBy(0,1350)", "");
				...
				jsx9.executeScript("window.scrollBy(0,-1350)", ""); 
				...
				jsx12.executeScript("window.scrollBy(0,1600)", "");
				...
				jsx13.executeScript("window.scrollBy(0,-1600)", ""); 
				...
				jsx14.executeScript("window.scrollBy(0,1650)", "");
				...
				jsx15.executeScript("window.scrollBy(0,-1650)", ""); 
