...
public class CLMJActivosIN {
	...
	@Test
	public void mjactivosin() throws InterruptedException {
		...
		// juuk Confirmados	
		driver.findElement(By.xpath("/html[1]/body[1]/div[1]/section[1]/div[1]/div[5]/a[1]/div[1]/div[2]/div[1]/div[2]")).click(); 
		Thread.sleep(10000);
		...
		// juuk Pendientes
		driver.findElement(By.xpath("/html[1]/body[1]/div[1]/section[1]/div[1]/div[3]/a[1]/div[1]/div[2]/div[1]/div[2]")).click(); 
		Thread.sleep(10000);
