...
public class CLMJFinalizadosES {
	WebDriver driver;
	...
	@Test
	public void mkfinalizadoses() throws InterruptedException {
		...
		// click en mis juuk		
		driver.findElement(By.xpath("//a[contains(text(),'Mis Juuks')]")).click(); 
		Thread.sleep(3000);
		...
		// juuk Cancelados
		driver.findElement(By.xpath("/html[1]/body[1]/div[1]/section[1]/div[1]/div[5]/a[1]")).click(); 
		Thread.sleep(10000);
		
		// juuk Confirmados atras	
		driver.findElement(By.xpath("//body/div[@id='__next']/section[1]/div[2]/div[1]/*[1]")).click(); 
		Thread.sleep(3000);
		...
		// juuk Finalizadas
		driver.findElement(By.xpath("/html[1]/body[1]/div[1]/section[1]/div[1]/div[7]/a[1]")).click(); 
		Thread.sleep(10000);
				
		// juuk finalizados atras	
		driver.findElement(By.xpath("//body/div[@id='__next']/section[1]/div[2]/div[1]/*[1]")).click(); 
		Thread.sleep(3000);
		
		//Ir a inicio
		driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[2]/div[1]/div[1]/div[1]/a[1]/img[1]")).click(); 
		Thread.sleep(3000);		
