...
public class SLPoliticas {
	...
	@Test
	public void politicas() throws InterruptedException {
		// Ir a Politicas		
		driver.findElement(By.xpath("//*[@id=\"__next\"]/footer/div/div/div[2]/a[1]")).click(); 
		Thread.sleep(3000);
